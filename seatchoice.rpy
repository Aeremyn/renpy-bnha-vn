label seatchoice:
    ...
    menu:
        "Sit behind to the proper looking girl with black hair.":
            call seatmomo
        "Sit behind boy with red and white hair.":
            call seatshoto
        "Sit behind the boy with spiky brown hair.":
            call seatrikido
        "Sit behind the smiling girl with brown hair.":
            call seatochako
return
