label lunchtime1:
    ...
    menu:
        "The smiling brown haired girl" if ochakoName != "Ochako":
            call lunch1ochako
        "Ochako" if ochakoName == "Ochako":
            call lunch1ochako
        "The shortish green haired boy.":
            call lunch1izuku
        "The fiesty looking blond.":
            call lunch1katsuki
        "The tall boy with glasses.":
            call lunch1tenya
        "The boy with red and white hair" if shotoName != "Todoroki":
            call lunch1shoto
        "Todoroki" if shotoName == "Todoroki":
            call lunch1shoto
        "Shinso":
            call lunch1hitoshi 
return
